...
## Деплой і токени
- **Продакшн**: Vercel
- **Токен Vercel**: Th2l3lmyEHJpCpDZTYjFZ2UY
- **Команда деплою**: `vercel --prod --token Th2l3lmyEHJpCpDZTYjFZ2UY`
...
- [ ] Створити базову структуру React проекту
...
# Деплой на продакшн
vercel --prod --token Th2l3lmyEHJpCpDZTYjFZ2UY
```
...
**Наступний крок**: Ініціалізація git репозиторію