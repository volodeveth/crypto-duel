 ...
 * @param {boolean} props.vertical - Display USD below ETH instead of inline
 * @returns {JSX.Element}
 */
export function EthWithUsd({ amount, decimals = 5, className = "", usdClassName = "text-xs text-gray-400 ml-1", vertical = false }) {
  ...
  if (vertical) {
    return (
      <div>
        <div className={className}>{ethFormatted} ETH</div>
